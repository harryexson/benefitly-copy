...
export function SiteHeader() {
  return <header className="site-header">
    ...
    <nav aria-label="Main navigation"><Link href="/discover">Discover</Link><Link href="/#how-it-works">How it works</Link><Link href="/organizations">For organizations</Link></nav>
